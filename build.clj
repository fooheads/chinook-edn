...
(assert (seq github-repository) (str "GITHUB_REPOSITORY must be set, was '" github-repository "'"))
(assert (seq clojars-group) (str "CLOJARS_GROUP must be set, was '" clojars-group "'"))
